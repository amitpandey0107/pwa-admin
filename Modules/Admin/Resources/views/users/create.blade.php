...
@section('admin::pagetitle', 'Add User')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        <div class="card-header card-header-success card-header-icon">
                            ...
                            <h4 class="card-title">User Registration
                                <a href="{{ route('users') }}">
                        ...
                        <div class="card-body">				           
                            ...
                            <form method="POST" class="form-horizontal" id="customerForm" enctype="multipart/form-data" action="{{ route('user-add') }}">
                                @csrf()
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group bmd-form-group">
                                            <input type="text" name="firstname" id="firstname" maxlength="50" class="form-control required" autocomplete="off"  value="{{ old('firstname') }}">
                                            @if ($errors->has('firstname'))
                                            <span class="error" role="firstname">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group bmd-form-group">
                                            <input type="text" name="lastname" id="lastname" maxlength="50" class="form-control required" autocomplete="off"  value="{{ old('lastname') }}">
                                            @if ($errors->has('lastname'))
                                            <span class="error" role="lastname">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group bmd-form-group">
                                            <input type="text" name="email" id="email" maxlength="100" class="form-control required email" autocomplete="off" value="{{ old('email') }}">
                                            @if ($errors->has('email'))
