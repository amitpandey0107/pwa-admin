   ...
   <script src="{{ asset('js/material-dashboard.minf066.js') }}"></script>
   ...
   <script type="text/javascript" src="{{ asset('lobibox/js/messageboxes.js') }}"></script>
   <script type="text/javascript" src="{{ asset('lobibox/js/notifications.js') }}"></script>
   ...
   <script>
     $(document).ready(function() {
       ...
       ! function(f, b, e, v, n, t, s) {
         ...
         document, 'script', '{{ asset("js/fbevents.js") }}');
